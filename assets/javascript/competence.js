...
// ---------------------------------------- //
// document.querySelectorAll(".myBar").forEach(function (element) {
//     element.style.width = element.getAttribute("data-pourcentage") + "%";
// });

// fait un boucle qui prend la data-pourcentage et l'applique à la barre de progression #mybar en width
var bars = document.getElementsByClassName("myBar");

if (document.getElementsByClassName(".animate-on-scroll.is-visible")) {
  for (let i = 0; i < bars.length; i++) {
    var bar = bars[i];
    var percentage = bar.getAttribute("data-pourcentage") + "%";
